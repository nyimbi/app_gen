...
def generate_agent_data():
    agent_data = {
        ...
        'kyc_verification_status': random.choice(verification_statuses),
...
for _ in range(1000):  # Generate 1000 sample agents
    agent_data = generate_agent_data()

    insert_sql = f"""
    INSERT INTO agent (
        is_aggregator, assigned_pos_count, verification_status,kyc_verification_status, verification_status_notes,
        ...
        {agent_data['is_aggregator']}, {agent_data['assigned_pos_count']}, '{agent_data['verification_status']}','{agent_data['kyc_verification_status']}',

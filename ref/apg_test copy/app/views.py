...
#    list_columns = ['name', 'notes']
appbuilder.add_view(
    AgentTierModelView, "AgentTiers", icon="fa-folder-open-o", category="Setup"
)
...
class BankModelView(ModelView):
    ...
    label_columns = {
        ...
        "sort_code": "Sort Code",
        "iban": "Iban",
        "cust_care_phone": "Cust Care Phone",
        "cust_care_email": "Cust Care Email",
...
appbuilder.add_view(
    ContactTypeModelView, "ContactTypes", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['name', 'code', 'phone_code']
appbuilder.add_view(
    CountryModelView, "Countrys", icon="fa-folder-open-o", category="Setup"
)
...
class CouponModelView(ModelView):
    ...
    list_columns = [
        ...
        "used",
        "used_date",
        "primary_scan_code_label",
        "is_return_coupon",
        "expiration_date",
        "generation_date",
        "activation_date",
        "secondary_scan_code_label",
        "scan_code_img",
        "coupon_code",
        "return_coupon_reason",
        "is_valid",
        "coupon_status",
        "discount_percentage",
        "coupon_count",
    ...
    label_columns = {
        ...
        "used": "Used",
        "used_date": "Used Date",
        "primary_scan_code_label": "Primary Scan Code Label",
        "is_return_coupon": "Is Return Coupon",
        "expiration_date": "Expiration Date",
        "generation_date": "Generation Date",
        "activation_date": "Activation Date",
        "secondary_scan_code_label": "Secondary Scan Code Label",
        "scan_code_img": "Scan Code Img",
        "coupon_code": "Coupon Code",
        "return_coupon_reason": "Return Coupon Reason",
        "is_valid": "Is Valid",
...
appbuilder.add_view(
    CouponModelView, "Coupons", icon="fa-folder-open-o", category="Setup"
)
...
class CurrencyModelView(ModelView):
    ...
    label_columns = {
        ...
        "internationalized_name_code": "Internationalized Name Code",
    }
    # base_filters = [['created_by', FilterEqualFunction, get_user],['name', FilterStartsWith, 'a']]
    # base_order = ("name", "asc")
    # page_size = 100
...
appbuilder.add_view(
    CurrencyModelView, "Currencys", icon="fa-folder-open-o", category="Setup"
)
...
class DocTypeModelView(ModelView):
    ...
    label_columns = {
        ...
        "serial_length": "Serial Length",
        "expires": "Expires",
        "validity_period": "Validity Period",
        "renewal_frequency": "Renewal Frequency",
        "is_government_issued": "Is Government Issued",
        "is_digital": "Is Digital",
...
appbuilder.add_view(
    DocTypeModelView, "DocTypes", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['label', 'mime_type', 'file_extension']
appbuilder.add_view(
    MimeTypeModelView, "MimeTypes", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['extension', 'mime_type']
appbuilder.add_view(
    MimeTypeMapModelView, "MimeTypeMaps", icon="fa-folder-open-o", category="Setup"
)
...
appbuilder.add_view(
    PaymentCardModelView, "PaymentCards", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['name', 'notes', 'start_date', 'end_date']
appbuilder.add_view(
    PromotionModelView, "Promotions", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['tp_key', 'tp_value', 'enabled', 'notes']
appbuilder.add_view(
    TechparamsModelView, "Techparamss", icon="fa-folder-open-o", category="Setup"
)
...
appbuilder.add_view(
    TokenProviderModelView, "TokenProviders", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['name', 'min_amount', 'max_amount', 'priority']
appbuilder.add_view(
    TransRoutingThresholdsModelView,
    "TransRoutingThresholdss",
    icon="fa-folder-open-o",
    category="Setup",
)
...
#    list_columns = ['name', 'notes']
appbuilder.add_view(
    TransTypeModelView, "TransTypes", icon="fa-folder-open-o", category="Setup"
)


class UserExtModelView(ModelView):
    datamodel = SQLAInterface(UserExt)
    list_title = "List System Users"
    show_title = "Show System User"
    edit_title = "Edit System Users"
    add_title = "Add System User"
...
appbuilder.add_view(
    UserExtModelView, "System Users", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['category', 'code', 'name', 'url', 'note']
appbuilder.add_view(
    BillerModelView, "Billers", icon="fa-folder-open-o", category="Setup"
)
...
class LgaModelView(ModelView):
    ...
    list_title = "List LGAs"
    show_title = "Show LGAs"
    edit_title = "Edit an LGA"
    add_title = "Add an LGA"
...
class AgentModelView(ModelView):
    ...
    list_columns = [
        ...
        "aggregator",
        "is_aggregator",
        "became_aggregator_date",
        "assigned_pos_count",
        "aggregator_pos_threshold",
        "verification_status",
    ...
    label_columns = {
        ...
        "is_aggregator": "Is Aggregator",
        "became_aggregator_date": "Became Aggregator Date",
        "assigned_pos_count": "Assigned Pos Count",
        "aggregator_pos_threshold": "Aggregator Pos Threshold",
        "verification_status": "Verification Status",
        "verification_status_notes": "Verification Status Notes",
        ...
        "alt_phone_country": "Alt Phone Country",
        "alt_phone": "Alt Phone",
        ...
        "bvn_verification_date": "BVN Verification Date",
        "bvn_verification_code": "BVN Verification Code",
        "tax_id": "Tax Id",
        "bank": "Bank",
        ...
        "biz_lga": "Biz Lga",
        "biz_city": "Biz City",
        "biz_city_area": "Biz City Area",
        "biz_street": "Biz Street",
        "biz_building": "Biz Building",
        "biz_address": "Biz Address",
        "biz_poa_img": "Biz PoA Img",
        "biz_poa_desc": "Biz PoA Desc",
        "biz_poa_valid": "Biz PoA Valid",
        ...
        "cac_reg_date": "CAC Reg Date",
        "cac_cert_img": "CAC Cert Img",
        "cac_cert_no": "CAC Cert No",
        "ref_code": "Ref Code",
        ...
        "approval_narrative": "Approval Narrative",
        "kyc_submit_date": "KYC Submit Date",
        "kyc_verification_status": "KYC Verification Status",
        "kyc_approval_date": "KYC Approval Date",
        "kyc_ref_code": "KYC Ref Code",
        "kyc_rejection_narrative": "KYC Rejection Narrative",
        "kyc_rejection_by": "KYC Rejection By",
        "rejection_date": "Rejection Date",
        "rejection_narrative": "Rejection Narrative",
        "rejected_by": "Rejected By",
        "face_matrix": "Face Matrix",
        "finger_print_img": "Finger Print Img",
        "agent_public_key": "Agent Public Key",
        "agent_pj_expiry": "Agent Pj Expiry",
...
class PosModelView(ModelView):
    ...
    label_columns = {
        ...
        "device_mfg": "Device Manufacturer",
        ...
        "assigned_narrative": "Assignment Narrative",
        "active": "Active",
        "activation_date": "Activation Date",
        "last_active": "Last Active",
        "deployed": "Deployed",
        "deploy_date": "Deploy Date",
        "deploy_narrative": "Deploy Narrative",
        "returned": "Returned",
        "return_date": "Return Date",
        "return_narrative": "Return Narrative",
        "return_received_date": "Return Received Date",
        "return_received_by": "Return Received By",
        "state": "State",
        "lga": "Lga",
        "street_address": "Street Address",
        "building_name": "Building Name",
        "contact_phone_num": "Contact Phone Num",
        "pos_user": "Pos User",
        "crypt_priv_key": "Crypt Priv Key",
        "crypt_pub_key": "Crypt Pub Key",
...
appbuilder.add_view(
    AgentPosLinkModelView, "Agent-Pos-Links", icon="fa-folder-open-o", category="Setup"
)


class CommRefModelView(ModelView):
    datamodel = SQLAInterface(CommRef)
    list_title = "List Commission References"
    show_title = "Show Commission Reference"
    edit_title = "Edit Commission Reference"
    ...
    description_columns = {
        "cr_id": "Unique identifier for the commission reference.",
    ...
    label_columns = {
        "cr_id": "Cr Id",
        "agent_type": "Agent Type",
        "agent_tier_level": "Agent Tier Level",
        "agent": "Agent",
        "state": "State",
        "lga": "Lga",
        "biller": "Biller",
        "biller_offering": "Biller Offering",
        "transaction_type": "Transaction Type",
        "customer_segment": "Customer Segment",
        "special_promotion": "Special Promotion",
        "min_trans_amount": "Min Transaction Amount",
        "max_trans_amount": "Max Transaction Amount",
        "min_max_step": "Min Max Step",
        "min_comm_amount": "Min Commission Amount",
        "max_comm_amount": "Max Commission Amount",
...
appbuilder.add_view(
    CommRefModelView, "Commission Refs", icon="fa-folder-open-o", category="Setup"
)
...
class PersonModelView(ModelView):
    ...
    label_columns = {
        ...
        "nick_name": "Nick Name",
        "gender": "Gender",
        "photo_img": "Photograph",
        "signature_img": "Signature Img",
        "bvn_no": "BVN No",
        "bvn_verified": "BVN Verified",
        "bvn_verification_date": "BVN Verification Date",
        "bvn_verification_code": "BVN Verification Code",
        "tax_id": "Tax Id",
        "home_poa_img": "Home Proof of Address (Picture)",
        "home_poa_desc": "Home Proof of Address Description",
        "home_poa_valid": "Is Home Proof of Address Valid?",
        "home_lat": "Home Latitude",
        "home_lon": "Home Longitude",
        "home_loc": "Home Location",
        "home_ggl_code": "Home Ggl Code",
    }
    # base_filters = [['created_by', FilterEqualFunction, get_user],['name', FilterStartsWith, 'a']]
    # base_order = ("name", "asc")
    # page_size = 100
...
appbuilder.add_view(
    PersonModelView, "People", icon="fa-folder-open-o", category="Setup"
)
...
class WalletModelView(ModelView):
    ...
    label_columns = {
        ...
        "wallet_locked": "Is Locked?",
        "wallet_active": "Is Active?",
        "wallet_code": "Wallet Code",
        "wallet_crypt": "Wallet Crypt",
        "wallet_narrative": "Wallet Narrative",
    }
    # base_filters = [['created_by', FilterEqualFunction, get_user],['name', FilterStartsWith, 'a']]
    # base_order = ("name", "asc")
    # page_size = 100
...
appbuilder.add_view(
    WalletModelView, "Wallets", icon="fa-folder-open-o", category="Setup"
)
...
class ContactModelView(ModelView):
    ...
    label_columns = {
        ...
        "contact": "Contact",
        "priority": "Priority",
        "best_time_to_contact_start": "Best Time To Contact Start",
        "best_time_to_contact_end": "Best Time To Contact End",
        "active_from_date": "Active From Date",
        "active_to_date": "Active To Date",
        "for_business_use": "For Business Use",
        "for_personal_use": "For Personal Use",
...
appbuilder.add_view(
    ContactModelView, "Contacts", icon="fa-folder-open-o", category="Setup"
)
...
class DocModelView(ModelView):
    ...
    label_columns = {
        ...
        "person": "Person",
        "agent": "Agent",
        "doc_front_img": "Doc Front Img",
        "doc_back_img": "Doc Back Img",
        "doc_name": "Doc Name",
...
appbuilder.add_view(
    DocModelView, "Documents", icon="fa-folder-open-o", category="Setup"
)
...
class PersonAdminDataModelView(ModelView):
    ...
    list_columns = [
        ...
        "do_not_trade",
        "opted_out",
        "do_not_track_update_date",
        "do_not_process_from_update_date",
        "do_not_market_from_update_date",
        "do_not_track_location_update_date",
        "do_not_profile_from_update_date",
        "do_forget_me_from_update_date",
        "do_not_process_reason",
        "no_merge_reason",
        "do_extract_my_data_update_date",
        "should_forget",
        "consumer_credit_score_provider_name",
        "web_site_url",
        "ordering_name",
        "hospitalizations_last5_years_count",
        "surgeries_last5_years_count",
        "dependent_count",
        "account_locked",
        "send_individual_data",
        "influencer_rating",
    ]
    ...
    label_columns = {
        ...
        "failed_login_timestamp": "Failed Login Timestamp",
        "password_last_set_time": "Password Last Set Time",
        "profile_picture": "Profile Picture",
        "awatar": "Awatar",
        "screen_name": "Screen Name",
        "user_priv_cert": "User Priv Cert",
        "user_pub_cert": "User Pub Cert",
        "alt_security_identities": "Alt Security Identities",
        "generated_UID": "Generated Uid",
        ...
        "opted_out": "Opted Out",
        "do_not_track_update_date": "Do Not Track Update Date",
        "do_not_process_from_update_date": "Do Not Process From Update Date",
        "do_not_market_from_update_date": "Do Not Market From Update Date",
        "do_not_track_location_update_date": "Do Not Track Location Update Date",
        "do_not_profile_from_update_date": "Do Not Profile From Update Date",
        "do_forget_me_from_update_date": "Do Forget Me From Update Date",
        "do_not_process_reason": "Do Not Process Reason",
        "no_merge_reason": "No Merge Reason",
        "do_extract_my_data_update_date": "Do Extract My Data Update Date",
        "should_forget": "Should Forget",
        "consumer_credit_score_provider_name": "Consumer Credit Score Provider Name",
        "web_site_url": "Web Site Url",
        "ordering_name": "Ordering Name",
        "hospitalizations_last5_years_count": "Hospitalizations Last5 Years Count",
        "surgeries_last5_years_count": "Surgeries Last5 Years Count",
        "dependent_count": "Dependent Count",
        "account_locked": "Account Locked",
        "send_individual_data": "Send Individual Data",
        "influencer_rating": "Influencer Rating",
    }
    # base_filters = [['created_by', FilterEqualFunction, get_user],['name', FilterStartsWith, 'a']]
    # base_order = ("name", "asc")
...
class TransModelView(ModelView):
    ...
    list_columns = [
        ...
        "origin_trans_notes",
        "origin_bank",
        "origin_institution_code",
        "origin_account_num",
        "origin_account_name",
        "origin_KYC_Level",
        "origin_Bank_Verification_Number",
        "origin_bvn",
        "session_ref",
        "transaction_ref",
        "channelCode",
        ...
        "bene_bank",
        "bene_account_num",
        "bene_institution_code",
        "bene_bank_verification_number",
        "bene_KYC_Level",
        "bene_account_name",
        "bene_phone_number",
        "bene_phone_denom",
        ...
        "comm_narration",
        "trans_currency",
        "trans_convert_currency",
        "trans_currency_exchange_rate",
        "trans_date",
        "customer_segment",
        "agent_tier_level",
        "special_promotions",
        ...
        "fraud_eval_outcome",
        "fraud_risk_score",
        "fraud_prediction_explanations",
        "fraud_rule_evaluations",
        "fraud_event_num",
        "trans_narration",
    ]
    ...
    label_columns = {
        ...
        "trans_purpose": "Trans Purpose",
        "customer_id": "Customer Id",
        "transaction_type": "Transaction Type",
        "card_trans_type": "Card Trans Type",
        "agent": "Agent",
        ...
        "trans_route": "Trans Route",
        "origin_source": "Origin Source",
        "origin_ref_code": "Origin Ref Code",
        "origin_trans_notes": "Origin Trans Notes",
        "origin_bank": "Origin Bank",
        "origin_institution_code": "Origin Institution Code",
        "origin_account_num": "Origin Account Num",
        "origin_account_name": "Origin Account Name",
        "origin_KYC_Level": "Origin Kyc Level",
        "origin_Bank_Verification_Number": "Origin Bank Verification Number",
        "origin_bvn": "Origin Bvn",
        "session_ref": "Session Ref",
        "transaction_ref": "Transaction Ref",
        "channelCode": "Channelcode",
        "name_enquiry_ref": "Name Enquiry Ref",
        "api_transactionid": "Api Transactionid",
        "receipt_no": "Receipt No",
        "pin_based": "Pin Based",
        "pin_code": "Pin Code",
        "pin_option": "Pin Option",
        ...
        "bene_ref_code": "Bene Ref Code",
        "bene_trans_notes": "Bene Trans Notes",
        "bene_bank": "Bene Bank",
        "bene_account_num": "Bene Account Num",
        "bene_institution_code": "Bene Institution Code",
        "bene_bank_verification_number": "Bene Bank Verification Number",
        "bene_KYC_Level": "Bene Kyc Level",
        "bene_account_name": "Bene Account Name",
        "bene_phone_number": "Bene Phone Number",
        "bene_phone_denom": "Bene Phone Denom",
        "bene_phone_product": "Bene Phone Product",
        "transaction_amount": "Transaction Amount",
        "available_balance": "Available Balance",
        "svc_fees": "Svc Fees",
        "comm_total": "Comm Total",
        "comm_agent": "Comm Agent",
        "comm_aggr": "Comm Aggr",
        "comm_ours": "Comm Ours",
        "comm_other": "Comm Other",
        "comm_net_pct": "Comm Net Pct",
        "tax": "Tax",
        "excise_duty": "Excise Duty",
        "vat": "Vat",
        "transmit_amount": "Transmit Amount",
        "comm_narration": "Comm Narration",
        "trans_currency": "Trans Currency",
        "trans_convert_currency": "Trans Convert Currency",
        "trans_currency_exchange_rate": "Trans Currency Exchange Rate",
        "trans_date": "Trans Date",
        "customer_segment": "Customer Segment",
        "agent_tier_level": "Agent Tier Level",
        "special_promotions": "Special Promotions",
        "fraud_marker": "Fraud Marker",
        "fraud_eval_outcome": "Fraud Eval Outcome",
        "fraud_risk_score": "Fraud Risk Score",
        "fraud_prediction_explanations": "Fraud Prediction Explanations",
        "fraud_rule_evaluations": "Fraud Rule Evaluations",
        "fraud_event_num": "Fraud Event Num",
        "trans_narration": "Trans Narration",
    }
...
class AgentDocLinkModelView(ModelView):
    ...
    description_columns = {
        ...
        "verification_status": 'Status of document verification, with a default value of "pending".',
...
#    list_columns = ['agent', 'doc', 'verification_status', 'submit_date', 'notes']
appbuilder.add_view(
    AgentDocLinkModelView, "AgentDocLinks", icon="fa-folder-open-o", category="Setup"
)
...
#    list_columns = ['person', 'doc', 'verification_status', 'submit_date']
appbuilder.add_view(
    PersonDocLinkModelView, "PersonDocLinks", icon="fa-folder-open-o", category="Setup"
)
...
appbuilder.add_view(
    UserExt_UserExtMasterDetailView,
    "UserExts",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    BillerCategory_BillerMasterDetailView,
    "BillerCategorys",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    TokenProvider_TokenMasterDetailView,
    "TokenProviders",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Biller_BillerOfferingMasterDetailView,
    "Billers",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    State_LgaMasterDetailView, "States", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Agent_AgentMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Bank_AgentMasterDetailView, "Banks", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Lga_AgentMasterDetailView, "Lgas", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    State_AgentMasterDetailView, "States", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    AgentTier_AgentMasterDetailView,
    "AgentTiers",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    UserExt_PosMasterDetailView, "UserExts", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    State_PosMasterDetailView, "States", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Lga_PosMasterDetailView, "Lgas", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Agent_AgentPosLinkMasterDetailView,
    "Agents",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Pos_AgentPosLinkMasterDetailView, "Poss", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    CustomerSegment_CommRefMasterDetailView,
    "CustomerSegments",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    AgentTier_CommRefMasterDetailView,
    "AgentTiers",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    BillerOffering_CommRefMasterDetailView,
    "BillerOfferings",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Lga_CommRefMasterDetailView, "Lgas", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    State_CommRefMasterDetailView, "States", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Biller_CommRefMasterDetailView,
    "Billers",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Promotion_CommRefMasterDetailView,
    "Promotions",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Agent_CommRefMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    TransType_CommRefMasterDetailView,
    "TransTypes",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Agent_PersonMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Person_PersonMasterDetailView, "People", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Agent_WalletMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Pos_WalletMasterDetailView, "Poss", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Person_AgentPersonLinkMasterDetailView,
    "People",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Agent_AgentPersonLinkMasterDetailView,
    "Agents",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Person_ContactMasterDetailView, "People", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Agent_ContactMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    ContactType_ContactMasterDetailView,
    "ContactTypes",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Agent_DocMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Person_DocMasterDetailView, "People", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    DocType_DocMasterDetailView, "DocTypes", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Person_PersonAdminDataMasterDetailView,
    "People",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Bank_TransMasterDetailView, "Banks", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    PaymentCard_TransMasterDetailView,
    "PaymentCards",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    CustomerSegment_TransMasterDetailView,
    "CustomerSegments",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Pos_TransMasterDetailView, "Poss", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    AgentTier_TransMasterDetailView,
    "AgentTiers",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    TransRoutingThresholds_TransMasterDetailView,
    "TransRoutingThresholdss",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Promotion_TransMasterDetailView,
    "Promotions",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Wallet_TransMasterDetailView, "Wallets", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Biller_TransMasterDetailView, "Billers", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Agent_TransMasterDetailView, "Agents", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Currency_TransMasterDetailView,
    "Currencys",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    BillerOffering_TransMasterDetailView,
    "BillerOfferings",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Coupon_TransMasterDetailView, "Coupons", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Agent_AgentDocLinkMasterDetailView,
    "Agents",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Doc_AgentDocLinkMasterDetailView, "Docs", icon="fa-folder-open-o", category="Review"
)
...
appbuilder.add_view(
    Doc_PersonDocLinkMasterDetailView,
    "Docs",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    Person_PersonDocLinkMasterDetailView,
    "People",
    icon="fa-folder-open-o",
    category="Review",
)
...
appbuilder.add_view(
    UserExtMultipleView, "UserExts", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_view(
    LgaMultipleView, "Lgas", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_view(
    PosMultipleView, "Poss", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_view(
    TransTypeMultipleView, "TransTypes", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_view(
    PersonMultipleView, "People", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_view(
    AgentMultipleView, "Agents", icon="fa-folder-open-o", category="Inspect"
)


class ContactTypeMultipleView(MultipleView):
    datamodel = SQLAInterface(ContactType)
    views = [AgentModelView, ContactTypeModelView, PersonModelView]


appbuilder.add_view(
    ContactTypeMultipleView, "ContactTypes", icon="fa-folder-open-o", category="Inspect"
)


class DocTypeMultipleView(MultipleView):
    datamodel = SQLAInterface(DocType)
    views = [MimeTypeModelView, AgentModelView, DocTypeModelView, PersonModelView]


appbuilder.add_view(
    DocTypeMultipleView, "DocTypes", icon="fa-folder-open-o", category="Inspect"
)


class BankMultipleView(MultipleView):
    datamodel = SQLAInterface(Bank)
    views = [
        PaymentCardModelView,
        CustomerSegmentModelView,
        TransRoutingThresholdsModelView,
        BillerModelView,
        BillerOfferingModelView,
...
appbuilder.add_view(
    BankMultipleView, "Banks", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_view(
    DocMultipleView, "Docs", icon="fa-folder-open-o", category="Inspect"
)
...
appbuilder.add_link(
    "graphql", href="/graphql", icon="fa-wrench", label="GraphQL", category="Utilities"
)

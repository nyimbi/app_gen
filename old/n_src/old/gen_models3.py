...
def process_default_value(default):
    ...
    if isinstance(default, str):
        ...
        if default_lower == 'now()' or default_lower == 'current_timestamp':
            return 'func.now()'
            ...
            return default
        elif default_lower.startswith('nextval'):
            # Handle sequences or autoincrement fields
            return None  # SQLAlchemy handles this automatically
        else:

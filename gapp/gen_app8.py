...
fastRTC applications, chatbots, speech-to-text, text-to-speech, microservices, and additional
components/artifacts for deployment and specialized modules.
...
# Updated Python Project Templates including new types: fastRTC, chatbot, speech-to-text,
    ...
    "flask_appbuilder": {
        ...
        "files": [
            ...
            },
            {
                ...
                "description": "Full-text search mixins for enhanced querying.",
            },
            {
            ...
            },
            {
                ...
                "description": "Custom validators for complex business rules.",
            },
        ],
    },
    "data_science": {
...
def main() -> None:
    ...
    generate_components = (
        input(
            "Would you like to generate additional components (e.g., messaging, logging modules)? (y/N): "
        )
        .strip()
        .lower()
        == "y"
